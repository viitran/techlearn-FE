<template>
    ...
    <div class="container  w-100 my-5 h-100">
        ...
        <div class="mb-3">
            <textarea  class="form-control shadow" id="exampleFormControlTextarea1" rows="10" v-model="promptAI.contentPrompt"> 
</textarea>
        </div>
        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
             <button class="btn btn-primary me-md-2" @click="submitPrompt" type="button">Submit</button>
