<template>
  ...
  <div class="container w-100 my-1 h-100    ">
    <div>
      <h4>CẤU HÌNH PROMPT REVIEW BÀI TẬP</h4>
    </div>
    ...
    <div class="d-flex flex-wrap">
      ...
      >
        <div class="card-body">
          <div class="mb-2">
            <strong class="card-title strong">ID PROMPT : {{ i.id }}</strong>
          ...
          <p
            v-if="i.promptStructure.length > 150"
            :id="'popover-target' + i.id"
            class="card-text"
          >
